...
1. Create the public GitHub repository `leolazz/steering-denoiser` and push this
   directory.
...
4. Run all cells. The bootstrap uses the current checkout when present and otherwise
   clones `https://github.com/leolazz/steering-denoiser.git`.
...
No software license is asserted automatically by this cleanup pass. Add the license
you intend to grant before making the repository public.
